...
let GameMaster = (_dec = NearBindgen({
  ...
  transferLoot({
    ...
    assert(predecessorAccountId() === this.owner, "Must be called by GameMaster Owner"); // Transfer NFT logic here
  }
  ...
  transferGold({
    ...
    assert(predecessorAccountId() === this.owner, "Must be called by GameMaster Owner"); // Transfer GOLD logic here
  }
