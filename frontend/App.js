    ...
    <Container fluid style={{backgroundColor: '#03293E'}}>
      ...
      <div style={{marginBottom: 40, color: '#9E8475'}}>
        <Row style={{display: 'flex',justifyContent:'center', marginBottom: 40, marginTop: 60}}>
          <Col sm={8} style={{fontSize: 26, fontWeight: 800, textAlign: 'center', letterSpacing: .5}}>
        ...
        <Row style={{justifyContent:'center', fontSize: 18}}>
          <Col sm={3} style={{ fontWeight: 'bold', lineHeight: 2}}>
          The year is 1989.
